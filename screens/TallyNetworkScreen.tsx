        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
          <View style={styles.wipContainer}>
            ...
            <Text style={styles.wipText}>
              Tally Network module is currently under development.
            </Text>
            <Text style={styles.wipSubtext}>
              This module will help you connect with other businesses in the Tally network, share resources, and collaborate on transactions.
            </Text>
          </View>
        </ScrollView>
        <BottomNavBar />
