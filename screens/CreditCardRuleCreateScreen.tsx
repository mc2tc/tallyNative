  ...
  const handleSave = useCallback(async () => {
    if (!businessId) {
      Alert.alert(
        ...
        'Sign in or select a business to create credit card rules.',
      )
      return
    }
    ...
    try {
      setSaving(true)
      await creditCardRulesApi.createRule({
        businessId,
        title: title.trim(),
      ...
      Alert.alert('Rule created', 'Your credit card rule has been created.', [
        {
          text: 'OK',
      ...
      console.error('Failed to create credit card rule:', error)
      Alert.alert(
        'Create failed',
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>NEW CREDIT CARD RULE</Text>
        ...
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.readonlyRow}>
              ...
              <Text style={styles.readonlyValue}>Credit Card</Text>
            </View>
          </View>
        </ScrollView>
